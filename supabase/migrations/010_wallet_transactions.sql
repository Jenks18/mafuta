...
-- Tracks all wallet deposits, withdrawals, and payments
-- =====================================================
...
-- Fleet admins/managers can view company wallet transactions
...
-- Users can create their own wallet transactions
...
-- Fleet admins can create company wallet transactions
