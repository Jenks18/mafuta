  ...
  if (isDesktop) {
    return (
      <div className="flex-1 flex flex-col relative overflow-hidden bg-gray-50">
        {/* Desktop Header */}
        <div className="relative z-20 bg-white border-b border-gray-200 px-6 py-4 shadow-sm">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1 relative max-w-2xl">
              ...
              <input
                ...
                placeholder="Search"
                className="w-full pl-12 pr-4 py-3 bg-white border border-gray-300 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent"
              />
            </div>

            {/* Balance */}
            <div className="bg-emerald-50 border border-emerald-200 rounded-full px-6 py-3">
              <span className="text-emerald-700 font-semibold text-sm">$0.00</span>
            </div>

            {/* Profile */}
            <button className="w-11 h-11 bg-emerald-600 rounded-full flex items-center justify-center hover:bg-emerald-700 transition-colors">
            ...
            <div className="absolute top-4 left-4 flex flex-col gap-3 z-10">
              ...
              <div className="bg-white rounded-xl shadow-lg p-3 flex gap-2">
                {filters.map((filter) => (
                  ...
                  >
                    <div className={`text-xl ${!filter.enabled && selectedFilter !== filter.id ? 'grayscale opacity-50' : ''}`}>
                      {filter.icon}
                    </div>
    ...
    <div className="flex-1 flex flex-col relative overflow-hidden">
      ...
      <div className="relative flex-1">
        ...
        <div className="absolute bottom-32 left-1/2 transform -translate-x-1/2 z-10">
          <button 
            onClick={handleSearchArea}
            className="bg-white px-4 py-2 rounded-full shadow-lg text-sm font-medium text-emerald-600 hover:bg-gray-50 transition-colors"
          >
            Search this area
          </button>
        </div>
