    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
      <div className="divide-y">
        ...
        <div className="flex items-start gap-4 p-5">
          <div className="mt-0.5 w-9 h-9 rounded-lg bg-gray-100 text-gray-700 flex items-center justify-center">
          ...
          <div className="flex-1">
            ...
            <div className="text-xs text-gray-500 mt-1">Billing Period: {billingPeriod}</div>
          </div>
        </div>
        {/* Account balance */}
        <div className="flex items-start gap-4 p-5">
          <div className="mt-0.5 w-9 h-9 rounded-lg bg-gray-100 text-gray-700 flex items-center justify-center">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h18M7 15h1m4 0h7M5 6h14a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2z"/></svg>
          </div>
          <div className="flex-1">
            <div className="text-sm text-gray-700">Account Balance: <span className="font-semibold">{currencyKES(accountBalanceKES)}</span></div>
            <div className="text-xs text-gray-500 mt-1">As of today</div>
          </div>
        </div>
      </div>
    </div>
