...
const FindFuelPage = () => {
  ...
  useEffect(() => {
    ...
    fuelStations.forEach((station, index) => {
      ...
      markerEl.innerHTML = `
        <div class="bg-emerald-600 text-white px-2 py-1 rounded-full text-xs font-bold shadow-lg flex items-center gap-1 cursor-pointer">
  ...
  return (
    <div className="flex-1 flex flex-col relative overflow-hidden">
      ...
      <div className="relative z-20 bg-white px-4 py-3 border-b border-gray-100">
        <div className="flex gap-4 max-w-6xl mx-auto justify-center">
          {filters.map((filter) => (
            <button
              key={filter.id}
      ...
      <div 
        className={`absolute bottom-0 left-0 right-0 bg-white rounded-t-2xl shadow-2xl transition-all duration-300 ${
          isDrawerExpanded ? 'h-4/5' : 'h-auto'
        }`}
        style={{ 
                    ...
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex gap-2 ml-4">
                        ...
                        <button 
                          ...
                          className="bg-emerald-600 hover:bg-emerald-700 text-white font-medium px-3 py-2 rounded-lg text-sm transition-colors"
                        >
                          Claim
                        </button>
                      </div>
