...
function App() {
  ...
  const fuelStations = [
    { id: 1, name: 'TA Petro', price: 3.20, lat: 40.7608, lng: -111.891, brand: 'TA', city: 'Salt Lake City', state: 'UT' },
    { id: 2, name: 'Chevron', price: 3.94, lat: 40.7708, lng: -111.900, brand: 'Chevron', city: 'Salt Lake City', state: 'UT' },
    { id: 3, name: 'Shell', price: 3.24, lat: 40.7508, lng: -111.880, brand: 'Shell', city: 'Salt Lake City', state: 'UT' },
    { id: 4, name: 'Maverik', price: 3.88, lat: 40.7658, lng: -111.895, brand: 'Maverik', city: 'Salt Lake City', state: 'UT' },
    { id: 5, name: 'Sinclair', price: 3.92, lat: 40.7558, lng: -111.885, brand: 'Sinclair', city: 'Salt Lake City', state: 'UT' },
    { id: 6, name: '7-Eleven', price: 3.32, lat: 40.7458, lng: -111.870, brand: '7-Eleven', city: 'Salt Lake City', state: 'UT' },
  ];

  // Remove the unnecessary outer div from the main return
  // ...existing code...
  ...
  const FindFuelPage = () => (
    <div className="flex-1 flex flex-col bg-gray-50">
      ...
      <div className="bg-white border-b border-gray-200">
        <div className="flex items-center justify-between h-16 px-6">
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-lg font-semibold text-gray-800">Best Charging Stations Near Me</h1>
          </div>
          <button className="p-2 hover:bg-gray-100 rounded-lg">
            <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      {/* Map container that fills all available space */}
      <div className="relative flex-1 min-h-0">
        {/* Map background with a more realistic green map style */}
        <div className="absolute inset-0 bg-gradient-to-br from-green-100 via-emerald-50 to-green-200" 
             style={{
               backgroundImage: `
          ...
          {/* Price markers positioned like in your screenshots */}
  ...
  const TransactionsPage = () => (
    <div className="flex-1 flex flex-col items-center justify-center bg-gray-50">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-emerald-700 mb-2">Transactions</h1>
  ...
  const MapPage = () => (
    <div className="flex-1 flex flex-col items-center justify-center bg-gray-50">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-emerald-700 mb-2">Map</h1>
        <p className="text-gray-600">Find fuel stations on the map.</p>
      </div>
    </div>
  )
  ...
  const MorePage = () => (
    <div className="flex-1 flex flex-col items-center justify-center bg-gray-50">
      <div className="text-center">
        <h1 className="text-2xl font-bold text-emerald-700 mb-2">More</h1>
        <p className="text-gray-600">Access settings and more features here.</p>
      </div>
    </div>
  )
  ...
  const CardsPage = () => {
    const cards = [
      { id: '0403', status: 'ACTIVE', assignedTo: 'admin', avatar: 'person' },
      { id: '4081', status: 'ACTIVE', assignedTo: 'Loading...', avatar: 'loading' },
      { id: '4737', status: 'INACTIVE', assignedTo: 'Anna', avatar: 'person' },
      { id: '2447', status: 'INACTIVE', assignedTo: 'admin', avatar: 'person' },
      { id: '5366', status: 'INACTIVE', assignedTo: 'Chris', avatar: 'person' },
      { id: '0333', status: 'INACTIVE', assignedTo: 'Loading...', avatar: 'loading' },
      { id: '2045', status: 'INACTIVE', assignedTo: 'Anna', avatar: 'person' },
    ];
      ...
      <div className="relative z-10 bg-gradient-to-br from-emerald-50 via-green-50 to-emerald-100 min-h-full">
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm border border-emerald-200/50 rounded-3xl p-6 shadow-lg">
            ...
            <button className="w-full bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white font-bold py-4 rounded-2xl text-lg transition-all shadow-lg">
              Refer and earn
            </button>
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-emerald-200/50 rounded-2xl p-4 shadow-lg">
              <div className="text-center">
                ...
                <button className="text-sm text-emerald-700 font-medium hover:text-emerald-800 transition-colors">
                  GENERATE QR
                </button>
              </div>
            </div>
            ...
            <div className="bg-white/60 backdrop-blur-sm border border-emerald-200/50 rounded-2xl p-4 shadow-lg">
              <div className="text-center">
                ...
                <button className="bg-gradient-to-r from-emerald-500 to-green-500 hover:from-emerald-600 hover:to-green-600 text-white font-bold px-6 py-2 rounded-xl text-sm transition-all shadow-md">
                  Share
                </button>
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                ...
                <div className="bg-white/60 backdrop-blur-sm border border-emerald-200/50 rounded-xl p-3 shadow-md">
                  <p className="text-gray-500 text-center text-sm">No contacts in this section</p>
                </div>
              </div>
            </div>
          </div>
